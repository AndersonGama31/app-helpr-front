...
export class ChamadosComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'titulo', 'nomeCliente', 'nomeTecnico', 'dataAbertura', 'prioridade', 'status', 'update', 'details'];
  ...
  constructor(service: ChamadosService, dialog: MatDialog) {
  ...
  openDetailsDialog(chamado: Chamado): void {
    this.dialog.open(DetailsComponent, { data: chamado, width: "400px" });
  }
}